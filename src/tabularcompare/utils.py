...
def report_to_xlsx(comparison,
                   only_deltas,
                   verbose,
                   output):
    output_xlsx = f"{comparison.df1_name}_to_{comparison.df2_name}_comparison_report.xlsx"
...
@cli_exception_handler
def report_to_html(comparison,
                   verbose,
                   output):
    output_html = f"{comparison.df1_name}_to_{comparison.df2_name}_comparison_report.html"
    if verbose:
